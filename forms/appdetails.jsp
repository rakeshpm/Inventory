	...
	<form name="addApp" action="/Inventory/addApp" method="post">
		...
		<table cellpadding="5" cellspacing="5">
			...
			<tr>
				...
				<td><input type="text" name="adoprimname" /></td>
			
				<td>Email</td>
				<td><input type="text" name="adoprimemail" /></td>
			
				<td>Number</td>
				<td><input type="text" name="adoprimcont" /></td>
			</tr>
			<tr>
				<td>ADO Secondary Contact Name</td>
				<td><input type="text" name="adosecdname" /></td>
			
				<td>Email</td>
				<td><input type="text" name="adosecdemail" /></td>
			
				<td>Number</td>
				<td><input type="text" name="adosecdcont" /></td>
			</tr>
			<tr>
				<td>ADO Escallation Contact Name</td>
				<td><input type="text" name="adomangname" /></td>
			
				<td>Email</td>
				<td><input type="text" name="adomangemail" /></td>
			
				<td>Number</td>
				<td><input type="text" name="adomangcont" /></td>
			</tr>
